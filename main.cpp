...
//https://github.com/koide3/iridescence/blob/master/src/example/ext_pointcloud_editor.cpp below

class PointCloudEditor {
public:
  PointCloudEditor( std::size_t _thinner):
  thinner(_thinner)
  {
...
int main(int argc, char** argv) {
  ...
  PointCloudEditor editor{thinner};
